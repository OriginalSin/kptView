...
var dic = {
	dStates: {					// Статус объекта недвижимости
		'01': 'Ранее учтенный',
		'05': 'Временный',
		'06': 'Учтенный',
		'07': 'Снят с учета',
	...
	dParcels: {					// Тип  объекта недвижимости
		'01': 'Землепользование',
	...
	dEncumbrances: {			// Ограничения (обременения) прав
	...
	dAllDocuments: {	// Все документы (Сборник классификаторов, коды 8.1, 8.2, 555, 558.1, 558.2, 558.3, 558.4, 558.5, 558.6)
	...
	dZone: {	//Территориальные зоны и зоны с особыми условиями использования территорий
	...
	dUtilizations: {	// Классификатор видов использования земель
	...
	dAssBuilding: {			// Назначение зданий
